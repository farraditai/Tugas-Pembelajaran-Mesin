...
if __name__ == '__main__':
    ...
    with open('train-processed'[:-4] + '-unique.txt', 'w') as uwf:
        uwf.write('\n'.join(unique_words))
    ...
    pkl_file_name = 'train-processed'[:-4] + '-freqdist.pkl'
    ...
    bi_pkl_file_name = 'train-processed'[:-4] + '-freqdist-bi.pkl'
...
#komentar :
#xrange diganti menjadi range (line 31)
#setiap sys.arg dihapus, diganti dengan nama file (line 56, 84, 91,97)
# setiap error "unsupported operand type(s) for %: 'NoneType' and 'str'", solusinya adalah tanda tutup kurung setelah %d' dihapus, dipindahkan ke paling belakang (line 88,94,100-107)